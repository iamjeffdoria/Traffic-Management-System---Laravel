<div id="create-potpot-mayors-permit-modal" class="hidden fixed inset-0 z-50 items-center justify-center px-4 py-6 overflow-y-auto">
    <div onclick="closeModal('create-potpot-mayors-permit-modal')" class="absolute inset-0 bg-black/50"></div>
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        <div class="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100 shrink-0">
            ...
            <button type="button" onclick="closeModal('create-potpot-mayors-permit-modal')" class="text-gray-400 hover:text-gray-600">
        ...
        <div class="flex gap-3 px-6 py-4 border-t border-gray-100 shrink-0">
            <button type="submit" form="potpot-mayors-permit-create-form"
                class="flex-1 rounded-full bg-red-600 text-white px-6 py-2.5 text-sm font-semibold hover:bg-red-700 transition-colors">
                Add Permit
            </button>
            <button type="button" onclick="closeModal('create-potpot-mayors-permit-modal')"
