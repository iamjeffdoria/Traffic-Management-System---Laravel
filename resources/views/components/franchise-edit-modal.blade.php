...
<div id="edit-franchise-modal" class="hidden fixed inset-0 z-50 items-center justify-center px-4 py-6 overflow-y-auto">
    <div onclick="closeModal('edit-franchise-modal')" class="absolute inset-0 bg-black/50"></div>
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        <div class="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100 shrink-0">
            ...
            <button type="button" onclick="closeModal('edit-franchise-modal')" class="text-gray-400 hover:text-gray-600">
        ...
        <form id="franchise-edit-form"
              data-franchise-form
              method="POST"
              action=""
              data-update-url-template="{{ route('tricycle.franchise.update', ['franchise' => '__ID__']) }}"
            ...
            <div>
                ...
                <input type="text" name="authorized_no" required
                    class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-600">
            </div>
            ...
            <div>
                ...
                <input type="text" name="official_receipt_no" required
                    class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-600">
            </div>
            <div>
