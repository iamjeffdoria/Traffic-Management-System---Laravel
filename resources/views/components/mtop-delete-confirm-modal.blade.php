<div id="delete-mtop-confirm-modal" class="hidden fixed inset-0 z-50 items-center justify-center px-4 py-6 overflow-y-auto">
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
        ...
        <h3 class="font-semibold text-gray-900 text-lg">Remove MTOP record?</h3>
        <p class="text-sm text-gray-500 mt-1">
            Are you sure you want to remove <span id="delete-mtop-confirm-name" class="font-medium text-gray-700"></span>? This can't be undone.
        </p>
        <div class="flex gap-3 mt-6">
            <button type="button" onclick="closeModal('delete-mtop-confirm-modal')"
            ...
            <button type="button" onclick="submitPendingMtopDelete()"
