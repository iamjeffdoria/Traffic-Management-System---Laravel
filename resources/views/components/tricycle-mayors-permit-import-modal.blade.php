<div id="import-tricycle-mayors-permit-modal" class="hidden fixed inset-0 z-50 items-center justify-center px-4 py-6 overflow-y-auto">
    <div onclick="closeModal('import-tricycle-mayors-permit-modal')" class="absolute inset-0 bg-black/50"></div>
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md flex flex-col">
        <div class="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100 shrink-0">
            ...
            <button type="button" onclick="closeModal('import-tricycle-mayors-permit-modal')" class="text-gray-400 hover:text-gray-600">
        ...
        <form id="tricycle-mayors-permit-import-form" method="POST" action="{{ route('tricycle.mayors-permit.import') }}" enctype="multipart/form-data" class="px-6 py-5">
            @csrf
            ...
            <label id="tricycle-mayors-permit-import-dropzone" for="tricycle-mayors-permit-import-input"
                ...
                <span id="tricycle-mayors-permit-import-filename" class="text-sm text-gray-600">Click to choose a file, or drag it here</span>
                <input type="file" name="file" id="tricycle-mayors-permit-import-input" accept=".xlsx,.xls,.csv" class="hidden">
            </label>

            <div class="flex gap-3 mt-6">
                <button type="submit" id="tricycle-mayors-permit-import-submit" disabled
                ...
                <button type="button" onclick="closeModal('import-tricycle-mayors-permit-modal')"
