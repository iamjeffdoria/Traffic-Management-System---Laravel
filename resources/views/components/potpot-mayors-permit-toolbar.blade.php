<div class="flex justify-end mb-6">
    <div class="inline-flex items-center overflow-hidden rounded-full">
        <button type="button" onclick="openModal('import-potpot-mayors-permit-modal')"
        ...
        <a href="{{ route('potpot.mayors-permit.export') }}"
        ...
        <button type="button" onclick="openModal('create-potpot-mayors-permit-modal')"
