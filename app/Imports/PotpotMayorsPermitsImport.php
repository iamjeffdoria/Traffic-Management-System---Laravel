...
class PotpotMayorsPermitsImport implements ToModel, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    ...
    public function model(array $row)
    {
        ...
        $data = [
            ...
            'name' => $this->toStringOrNull($row['name'] ?? null),
        ...
        return new PotpotMayorsPermit($data);
    }
